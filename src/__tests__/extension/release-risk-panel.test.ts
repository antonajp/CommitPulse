/**
 * Extension tests for the ReleaseRiskPanel webview.
...
// Mock release risk service
vi.mock('../../services/release-risk-service.js', () => ({
  ReleaseRiskService: vi.fn().mockImplementation(() => ({
    getCommitRiskChartData: vi.fn().mockResolvedValue({
      commits: [],
      hasData: false,
      viewExists: true,
    }),
    getReleaseRiskSummaryData: vi.fn().mockResolvedValue({
      summaries: [],
      hasData: false,
      viewExists: true,
    }),
    getCommitRisks: vi.fn().mockResolvedValue([]),
    checkCommitRiskViewExists: vi.fn().mockResolvedValue(true),
    checkReleaseRiskViewExists: vi.fn().mockResolvedValue(true),
  })),
}));
...
describe('ReleaseRiskPanel', () => {
  ...
  beforeEach(() => {
    ...
    // Reset the singleton
    ReleaseRiskPanel.resetForTesting();
    vi.clearAllMocks();
  });
