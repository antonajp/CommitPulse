...
/**
 * Extension tests for HotSpotsPanel (IQS-902).
...
describe('HotSpotsPanel', () => {
  ...
  describe('createOrShow', () => {
    it('should not throw when creating panel (integrity check will fail with mock)', () => {
      ...
      expect(() => {
        HotSpotsPanel.createOrShow(extensionUri, mockSecretService);
      }).not.toThrow();
    });
