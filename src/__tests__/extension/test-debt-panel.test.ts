/**
 * Extension tests for the TestDebtPanel webview.
...
// Mock test debt service
vi.mock('../../services/test-debt-service.js', () => ({
  TestDebtService: vi.fn().mockImplementation(() => ({
    getTestDebtTrendData: vi.fn().mockResolvedValue({
      weeks: [],
      hasData: false,
      viewExists: true,
    }),
    getLowTestCommitsData: vi.fn().mockResolvedValue({
      commits: [],
      hasData: false,
      viewExists: true,
    }),
    getLowTestCommits: vi.fn().mockResolvedValue([]),
    checkTestDebtViewExists: vi.fn().mockResolvedValue(true),
    checkCommitTestRatioViewExists: vi.fn().mockResolvedValue(true),
  })),
}));
