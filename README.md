...
## Architecture Classification Script

The `scripts/classify-arc-component.sql` script classifies files in the `commit_files` table into architecture components (Back-End, Front-End, Database, DevOps/CI, Configuration, Testing, Documentation, Build/Tooling, Assets, Other). This enables the Metrics Dashboard to show technology stack distribution charts.

### Classification Strategy

The script uses a **priority-based classification strategy** with 12 priority levels:
...
**LLM-informed decisions:** The script was generated by Claude analyzing 69,402 distinct filenames across 10 repositories. Key decisions include:
...
The script includes a summary query that runs automatically after classification:
...
3. **Run in force mode** to reclassify existing files.
