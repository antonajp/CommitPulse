...
- Move Dead Branches to Charts TreeView navigation

## [0.1.64] - 2026-08-03

### Added

- Add Dead Branches TreeView to sidebar
- Refactor Dead Branches Report to use commit_history table

## [0.1.63] - 2026-08-02

### Fixed

- Fix Dead Branches Report CSV export validation error
- Show all repositories in Dead Branches Report with accurate branch counts

## [0.1.62] - 2026-08-02

### Changed

- Document Dead Branches Report in README.md

### Fixed

- Fix Dead Branches Report incorrect risk levels and missing repositories

## [0.1.61] - 2026-07-31

### Added

- Add Dead Branches Report with Risk Categorization

### Changed

- Delegate DeadBranchesPanel data fetching to BranchRepository

### Fixed

- Call syncBranchesToDatabase instead of analyzeBranches
- Implement database queries and scan workflow for Dead Branches panel

## [0.1.60] - 2026-07-31

### Fixed

- Fix BitBucket Cloud 401 auth error with username setting

## [0.1.59] - 2026-07-31

### Added

- Add BitBucket support to PR Coverage Report
...
- Add 'Run Database Migrations' VS Code command
- Add contributor/team grouping and methodology explainer
- Add security hardening - audit logging, CSV integrity, CSP review
- Add PR Coverage Report dashboard
...
- Add PowerShell CLI examples and seed data guidance

### Fixed

- Dashboard visualization fixes for dark mode, legends, and LOC
...
- Remove duplicate variable declarations in team profile charts

## [0.1.52] - 2026-06-28

### Added

- Add Hot Spots and Knowledge Concentration charts to Team Profile
- Convert file tables to horizontal stacked bar charts

### Fixed

- Fix Comments Added chart showing 0 on profile dashboards

## [0.1.51] - 2026-06-27

### Changed

- Revert "fix(GITX-186): Calculate team averages as per-member averages, not sums"
- Revert "chore(release): Bump version to 0.1.50"

### Fixed

- Calculate per-member averages using separate contributor counts
- Calculate team averages as per-member averages, not sums
